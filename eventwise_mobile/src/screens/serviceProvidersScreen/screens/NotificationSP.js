...
import { View, Text, TouchableOpacity, StyleSheet, Image, ScrollView, Modal, TouchableWithoutFeedback } from 'react-native';
    ...
    switch (selectedTab) {
      ...
      case 'Booking Request':
        return notificationsData['Booking Request'].map(notification => (
          <View key={notification.id} style={styles.notificationBox}>
            <View style={styles.leftContainer}>
              <Image source={notification.image} style={styles.profilePicture} />
              <View style={styles.notificationDetails}>

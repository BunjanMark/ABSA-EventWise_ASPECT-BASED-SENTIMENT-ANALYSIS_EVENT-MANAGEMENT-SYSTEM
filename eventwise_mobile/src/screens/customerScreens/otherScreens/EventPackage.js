        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <Image source={require("../pictures/popupbg.png")}  style={styles.backgroundImage} />

              <Image source={require("../pictures/epckinc.png")}  style={styles.foregroundImage} />
...
const packageData = [
  { venue: 'Limketkai Luxe Hotel', address: '22-B, W White Road, Lapasan, CDO, 234567', image: require('../pictures/epck1.png') },
  { venue: 'Venue B', address: 'Address B', image: require('../pictures/epck2.png') },
  { venue: 'Venue C', address: 'Address C', image: require('../pictures/epck1.png') },
  { venue: 'Venue D', address: 'Address D', image: require('../pictures/epck2.png') },
];

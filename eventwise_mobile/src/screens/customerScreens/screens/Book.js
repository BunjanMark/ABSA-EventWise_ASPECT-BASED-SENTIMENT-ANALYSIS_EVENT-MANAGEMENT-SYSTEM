...
import { SafeAreaView, Alert, StyleSheet, View, Text, TouchableOpacity, KeyboardAvoidingView, Platform, ScrollView, TextInput } from 'react-native';
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.formGroup}>
            <Dropdown
              ...
              renderRightIcon={() => (
                <Icon name="caret-down" size={16} color="#000" style={styles.dropdownIcon} />
              )}
            />
          </View>
